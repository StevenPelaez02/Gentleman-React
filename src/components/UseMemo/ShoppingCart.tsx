// Objetivo: memorizar (cache) el resultado de ejecutar una funcion costosa, para evitar que se vuelva a llamar el metodo
...
// Si no agregamos nada y tampoco cambio nada, cual es el costo total?
...
export const ShoppingCart = () => {
  ...
  const totalCost = useMemo(() => 
    items.reduce((total:number, item:Item) => total + item.price, 0)
    , [items])
